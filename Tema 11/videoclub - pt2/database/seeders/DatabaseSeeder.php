...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayPeliculas = [
        ...
        [
            ...
            'rented' => true,
            'synopsis' => 'Acusado del asesinato de su mujer, Andrew Dufresne es enviado a la cárcel de Shawshank.'
        ],
        [
            'title' => 'El golpe',
            'year' => '1973',
    ...
    private function seedUsers(): void
    {
        ...
        echo "Tabla users poblada con éxito.\n";
    }

    /**
     * Seed the catalog (movies table)
     */
    private function seedCatalog(): void
    {
        // Vaciar la tabla movies
        Movie::truncate();

        // Recorrer el array de películas e insertarlas en la base de datos
        foreach ($this->arrayPeliculas as $pelicula) {
            Movie::create($pelicula);
        }

        echo "Tabla movies poblada con éxito.\n";
    }
}
