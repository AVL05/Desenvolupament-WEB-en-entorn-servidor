                    ...
                    <form method="POST" action="{{ route('polizas.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="tipo" name="tipo" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="Todo Riesgo" {{ old('tipo') == 'Todo Riesgo' ? 'selected' : '' }}>Todo Riesgo</option>
                                <option value="Terceros" {{ old('tipo') == 'Terceros' ? 'selected' : '' }}>Terceros</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="importe" class="block mt-1 w-full" type="number" step="0.01" name="importe" :value="old('importe')" required />
                            <x-input-error :messages="$errors->get('importe')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="fecha_comienzo" :value="__('Fecha de Comienzo')" />
                            <x-text-input id="fecha_comienzo" class="block mt-1 w-full" type="date" name="fecha_comienzo" :value="old('fecha_comienzo')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="fecha_renovacion" class="block mt-1 w-full" type="date" name="fecha_renovacion" :value="old('fecha_renovacion')" required />
